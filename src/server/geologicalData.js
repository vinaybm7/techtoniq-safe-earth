...
exports.fetchFaultLinesFromUSGS = void 0;
...
const fetchFaultLinesFromUSGS = async (lat, lng, radiusKm = 100) => {
    try {
        const response = await (0, node_fetch_1.default)(`https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=1900-01-01&latitude=${lat}&longitude=${lng}&maxradiuskm=${radiusKm}&producttype=fault`, {
            headers: {
...
exports.fetchFaultLinesFromUSGS = fetchFaultLinesFromUSGS;
