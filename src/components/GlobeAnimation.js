...
const GlobeAnimation = () => {
    ...
    return (_jsxs("div", { className: "globe-container relative w-full h-[500px] md:h-[600px] bg-transparent", children: [isLoading && (_jsxs("div", { className: "absolute inset-0 flex items-center justify-center z-10", children: [_jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-4 border-techtoniq-blue border-t-transparent" }), _jsx("p", { className: "ml-2 text-techtoniq-earth", children: "Loading globe..." })] })), hasError ? (_jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-gray-50 rounded-lg", children: _jsxs("div", { className: "text-center p-4", children: [_jsx("p", { className: "text-techtoniq-earth-dark", children: "Failed to load globe animation." }), _jsx("button", { className: "mt-2 px-4 py-2 bg-techtoniq-blue text-white rounded hover:bg-techtoniq-blue-dark transition-colors", onClick: () => window.location.reload(), children: "Try Again" })] }) })) : (_jsx("div", { className: cn("absolute inset-0 mx-auto aspect-[1/1] w-full max-w-[600px]"), children: _jsx("canvas", { className: cn("size-full opacity-0 transition-opacity duration-500 [contain:layout_paint_size]"), ref: canvasRef, onPointerDown: (e) => updatePointerInteraction(e.clientX - pointerInteractionMovement.current), onPointerUp: () => updatePointerInteraction(null), onPointerOut: () => updatePointerInteraction(null), onMouseMove: (e) => updateMovement(e.clientX), onTouchMove: (e) => e.touches[0] && updateMovement(e.touches[0].clientX) }) }))] }));
};
